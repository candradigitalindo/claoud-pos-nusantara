...
const NAV_ITEMS_DATA = [
  ...
  },
  {
    ...
    children: [
      ...
      { to: '/projects', label: 'Projek', permission: 'procurement.projects.view' },
  ...
  },
  {
    ...
    children: [
      { to: '/whatsapp', label: 'Koneksi & Notifikasi', permission: 'whatsapp.view' },
      { to: '/whatsapp/broadcast', label: 'Broadcast', permission: 'whatsapp.broadcast' },
      { to: '/whatsapp/messages', label: 'Log Pesan', permission: 'whatsapp.view' },
    ],
  },
  {
    label: 'Pengaturan',
